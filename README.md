...
- **279/279 standalone JavaScript probe checks pass** (`js_probe.mjs`) verifying strict primitive numeric validation, boundary argument rejections, object-immutability freeze, and UTC+1.1 carry normalization.
